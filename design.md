Section "Design" contains: [Palette generators](design.md#palette-generators), [Free stock photos](design.md#free-stock-photos), [Icons](design.md#icons), [Video](design.md#video)
...
Repository contains: [CSS-plugins](css-plugins.md#css), [JS-plugins](pureJS-plugins.md#js), [jQuery-plugins](jquery-plugins.md#jquery),  [Tools](tools.md#tools), [Design](design.md#design)
